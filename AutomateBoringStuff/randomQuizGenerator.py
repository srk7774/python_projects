...
for quizNum in range(35): 
    ...
    random_example.shuffle(states) # randomize the order of the states
    ...
    for questionNum in range(50):
        ...
        wrongAnswers = random_example.sample(wrongAnswers, 3) # pick 3 random ones

        answerOptions = wrongAnswers + [correctAnswer]
        random_example.shuffle(answerOptions) # randomize the order of the answers
